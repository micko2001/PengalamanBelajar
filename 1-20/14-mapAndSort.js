...
// map()
/*
Creates a new array with the same length as the 
original array, but with each element transformed 
...
//filter()
/*
Creates a new array with only the elements that 
pass the conditions implemented by the callback function.

Used when you want to select only certain elements that 
meet a specific condition.

Returns a new array with a length that is equal to or 
